# Повний аудит методів Seqeron.Genomics

## Всього: 277 public static методів
...
1. **Перевантаження** рахуються окремо (наприклад, GlobalAlign має 4 перевантаження = 4 методи)
2. **Extension methods** із SequenceExtensions включені (12 методів)
3. **StatisticsHelper** - внутрішній helper, може бути виключений з MCP (2 методи)
4. **SAM flags** у SequenceIO - 12 однорядкових методів для роботи з SAM прапорцями

## Дата аудиту: 2026-01-23
