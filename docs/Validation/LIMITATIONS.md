...
| MIRNA-CLEAVAGE-001 | The true **miRNA\*(3p) / star** sequence on the *opposite* hairpin arm — the star span is computed as a **linear** 2-nt-3′-overhang offset of the 5p mature, not by folding the precursor. (The Drosha/Dicer 5p mature cut itself reproduces miRBase exactly.) | A secondary-structure folding step (RNA-STRUCT-001), or the miRBase-annotated mature coordinates, for the opposite-arm star. |
