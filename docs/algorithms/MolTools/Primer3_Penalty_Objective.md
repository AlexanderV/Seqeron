...
- Tests: [PrimerDesigner_Primer3Penalty_Tests.cs](../../../tests/Seqeron/Seqeron.Genomics.Tests/Unit/MolTools/PrimerDesigner_Primer3Penalty_Tests.cs) — covers `INV-01`–`INV-05`
