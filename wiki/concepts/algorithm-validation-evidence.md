...
[[cpg-island-detection]] (the sequence-only CpG site enumeration / O-E ratio / Gardiner-Garden & Frommer CpG-island detection unit of the Epigenetics family, the fourth ingested EPIGEN-* unit — touches no methylation state).
