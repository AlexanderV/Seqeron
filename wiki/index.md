...
Directory of the sharded wiki indexes. Read the smallest relevant shard first; use the BM25 search fallback when these summaries do not surface a good candidate.

## Index shards

- [Project and governance sources](indexes/sources-project.md) - 16 source pages for project documentation and governance.
...
- [Concepts](indexes/concepts.md) - 213 algorithm, architecture, validation, and scientific-method concepts.
