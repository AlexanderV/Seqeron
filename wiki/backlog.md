...
Status at generation: **146** algorithm docs covered-via-concept, **97** pending across 17 domains
...
The per-domain pending tables (97 algorithm docs across 17 domains, no concept page yet) live in **[[backlog-pending]]** to keep this hub under the page-size cap. A pending row is resolved when a concept page lists the algorithm doc in `sources:`, at which point it moves to the *Covered via concept* table above.
