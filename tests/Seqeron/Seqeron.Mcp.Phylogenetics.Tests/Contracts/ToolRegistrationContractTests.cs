...
/// <summary>
/// Server contract / integration test: the Seqeron.Mcp.Phylogenetics server must advertise EXACTLY its documented
...
public class ToolRegistrationContractTests
{
    ...
    [Test]
    public void PhylogeneticsTools_AdvertisesExactlyTheDocumentedToolSurface()
    {
        var registered = GetRegisteredToolNames(typeof(PhylogeneticsTools));
    ...
    {
        var methods = typeof(PhylogeneticsTools).GetMethods(BindingFlags.Public | BindingFlags.Static);
