...
**Area:** MolTools
**Algorithm:** DNA Hairpin Folder + Secondary-Structure Tm
...
| # | Source |
|---|--------|
| 1 | SantaLucia (1998), SantaLucia & Hicks (2004), UNAFold DNA params |
...
- **Test fixture:** `tests/Seqeron/Seqeron.Genomics.Tests/PrimerDesigner_HairpinTm_Tests.cs`
